 ...
 * particular, you can set here the values of variables elements defined in aktestgame_aktestgame.tpl (elements
 ...
 */
  ...
  class view_aktestgame_aktestgame extends game_view
  {
    ...
    function build_page( $viewArgs )
  	{		
        ...
        */
        ...
        $this->page->begin_block( "aktestgame_aktestgame", "myblock" );
        ...
        */
        ...
        $this->page->begin_block( "aktestgame_aktestgame", "hex" );
        $this->page->begin_block( "aktestgame_aktestgame", "hexUnusable" );
        for( $x=0; $x<15; $x++ )
        {
            for ($y=0; $y<15; $y++)
            {
        ...
        $this->page->begin_block( "aktestgame_aktestgame", "playerBoard" );        
        foreach( $players as $player )
        {
